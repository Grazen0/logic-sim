// Copied from https://codeberg.org/ziglang/zig/src/branch/master/lib/std/deque.zig
// until this is included in the standard library
...
pub fn Deque(comptime T: type) type {
    return struct {
        ...
        // Copied from ArrayList since they aren't public in this version of Zig
        ...
        pub fn ensureTotalCapacity(deque: *Self, gpa: Allocator, new_capacity: usize) Allocator.Error!void {
            ...
            return deque.ensureTotalCapacityPrecise(gpa, Self.growCapacity(new_capacity));
        }
