...
const sumi_ink_0_dim: Color = .init(0x16, 0x16, 0x1D, 0xE0);
const sumi_ink_1_dim: Color = .init(0x1F, 0x1F, 0x28, 0xC0);
...
pub const dim = sumi_ink_1_dim;
pub const tooltip_bg = sumi_ink_0_dim;
